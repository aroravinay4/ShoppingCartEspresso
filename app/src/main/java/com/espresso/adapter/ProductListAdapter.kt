...
class ProductListAdapter(val context: Context, val productList: Array<Product>) :
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(product: Product) {
            ...
            val productImage = itemView.findViewById(R.id.product_image) as ImageView

            Glide.with(itemView)
                .load(getImage(product.image, itemView.context))
                .into(productImage)
